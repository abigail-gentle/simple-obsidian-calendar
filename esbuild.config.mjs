...
//   CHANGED: dotenv removed entirely — the repo is expected to be cloned directly
//            into .obsidian/plugins/, so outdir is always "./".
...
// Output always goes to the repo root. When the repo is cloned directly into
// .obsidian/plugins/<id>/ this is the correct plugin directory. There is no
// .env / TEST_VAULT indirection — just clone into the vault and run npm run dev.
const outdir = "./";
