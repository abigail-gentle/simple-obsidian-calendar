/**
 * Utility functions for the calendar UI.
 * Merged from:
 *   - obsidian-calendar-plugin/src/ui/utils.ts
 *   - obsidian-calendar-ui/src/utils.ts
 */
...
// ---------------------------------------------------------------------------
// classList — returns an array of CSS class names for truthy entries
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// getDateUIDFromFile — resolves day or week UID from a TFile
// ---------------------------------------------------------------------------

/**
 * Lookup the dateUID for a given file. Compares the filename to the
 * daily and weekly note formats to find a match.
 */
...
// ---------------------------------------------------------------------------
// getWordCount — unicode-aware word counter (ported directly from plugin)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// isMetaPressed — cross-platform meta/ctrl detection
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// getDaysOfWeek — locale-aware short day names
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// getMonth — generates a 6-week (42-day) calendar grid
// ---------------------------------------------------------------------------

/**
 * Generate a 2D array of daily information to power the calendar view.
 * Always returns exactly 6 weeks (42 days) regardless of month length.
 */
